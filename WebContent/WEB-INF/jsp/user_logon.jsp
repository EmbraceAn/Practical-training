							...
							<div class="row">
								...
								<div class="col-xl-12">
									<div class="input-wrap">
	                        			...
	                        			<form:errors path="userAlice" cssStyle="color:red;"/>
									</div>
								</div>
								<div class="col-xl-12">
									<div class="input-wrap">
										<form:label path="userPhone">手机号码</form:label>
								...
								<div class="col-xl-12">
									<div class="input-wrap">
										<label for="reuserPsw">确认密码</label>
										<input type="password" id="reuserPsw" name="reuserPsw">
									</div>
								</div>
								<div class="col-xl-12">
									<div class="input-wrap">
										<button type="submit" class="submit-btn">注册一个账户</button>
									</div>
								</div>

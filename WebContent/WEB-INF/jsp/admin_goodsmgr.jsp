				...
				<table class="table" cellspacing="0" style="font-size: 12px;">
			    	...
			    	<tr>
			    		...
			    		<td>${pro.price }</td>
			    					...
			    					<td><img style="width:40px;" src="${pageContext.request.contextPath}/upload/${pro.photo }"/></td>
			    		<td><a href="${pageContext.request.contextPath}/delete_wine?id=${pro.productId }&currentPage=">删除</a>&nbsp;
			    			<a href="${pageContext.request.contextPath}/admin/Wine_Edit.jsp?id=${pro.productId}">编辑</a></td>
			    	</tr>
			    	</c:forEach>
			    </table>
			    <!-- 分页效果 -->

		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-xl-3 col-lg-3 col-md-4 col-6">
					<div class="logo">
						<a href="index.html">
							<img src="${pageContext.request.contextPath}/statices/assets/img/logo/logo-2.png" alt="logo">
						</a>
					</div>
				</div>
				...
				<div class="col-xl-3 col-lg-3 d-none d-xl-block d-lg-block">
				...
				<div class="col-xl-3 col-lg-4 col-md-8 col-6 text-right  d-block d-xl-none d-lg-none">
...
<main>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide single-slide">
						...
						<div class="slider-thumb" data-animation="zoomIn" data-delay="0.3s">
							<img src="${pageContext.request.contextPath}/statices/assets/img/slider/slider-thumb-2.png" alt="slider">
						</div>
					</div>
					<div class="swiper-slide single-slide">
						<div class="container">
	...
	<div class="support-area">
		<div class="container">
			<div class="row support-bg">
				<div class="col-xl-4 col-lg-4">
					<div class="support-wrap">
						<div class="icon">
							<img src="${pageContext.request.contextPath}/statices/assets/img/icon/icon-4.png" alt="icon">
						</div>
						<div class="content">
							<h4>Support 24/7.</h4>
							<p>
				...
				<div class="col-xl-4 col-lg-4">
					<div class="support-wrap">
						<div class="icon">
							<img src="${pageContext.request.contextPath}/statices/assets/img/icon/icon-5.png" alt="icon">
						</div>
						<div class="content">
							<h4>Delivery.</h4>
							<p>
				...
				<div class="col-xl-4 col-lg-4">
					<div class="support-wrap">
						<div class="icon">
							<img src="${pageContext.request.contextPath}/statices/assets/img/icon/icon-6.png" alt="icon">
						</div>
						<div class="content">
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-4 col-md-6">
					<div class="banner-wrap-2 mb-30">
						<div class="banner-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/banner/banner-6.jpg" alt="banner">
						</div>
						<div class="banner-content text-center">
							<h4>
								<a href="product-grid.html">Corrugated Boxes</a>
							</h4>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-md-6">
					<div class="banner-wrap-2 mb-30">
						<div class="banner-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/banner/banner-7.jpg" alt="banner">
						</div>
						<div class="banner-content text-center">
							<h4>
								<a href="product-grid.html">Hazmat Boxes</a>
							</h4>
						</div>
					</div>
					<div class="banner-wrap-2 mb-30">
						<div class="banner-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/banner/banner-9.jpg" alt="banner">
						</div>
						<div class="banner-content text-right content-align-center">
							<h4>
								<a href="product-grid.html">Wood Crates</a>
							</h4>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-md-6">
					<div class="banner-wrap-2 mb-30">
						<div class="banner-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/banner/banner-8.jpg" alt="banner">
						</div>
						<div class="banner-content text-center">
							<h4>
								<a href="product-grid.html">Heavy Duty Boxes</a>
							</h4>
						</div>
					</div>
				</div>
	...
	<div class="product-area product-filter-wrapper pt-90 pb-90">
		<div class="container">
			...
			<div class="row product-filter-grid">
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item sales">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-13.jpg" alt="product">
						...
						<div class="product-content">
							<h4><a href="product-single.html">Storage File Boxes</a></h4>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item sales">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-14.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item sales">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-15.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item featured sales">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-16.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item featured">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-17.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item featured">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-18.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item featured">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-19.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 grid-item featured sales">
					<div class="product-wrap-2 mb-30">
						<div class="product-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-20.jpg" alt="product">
							<div class="product-action">
								<a href="#"><i class="far fa-search"></i></a>
								<a href="#"><i class="far fa-shopping-cart"></i></a>
								<a href="#"><i class="far fa-heart"></i></a>
	...
	<!-- cta-area start -->
	<div class="cta-area pt-md-100 pb-md-100 pt-xs-100 pb-xs-100">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-xl-7 col-lg-7">
					<div class="newsletter-form">
						<h4>Newsletter!</h4>
						<p>It only takes a second to be the first to find out about our latest news</p>
				...
				<div class="col-xl-5 col-lg-5 d-none d-xl-block d-lg-block">
					<div class="cta-thumb">
						<img src="${pageContext.request.contextPath}/statices/assets/img/thumb/thumb-3.png" alt="thumb">
					</div>
				</div>
			</div>
		</div>
		<div class="cta-thumb-1">
			<img src="${pageContext.request.contextPath}/statices/assets/img/shape/shape-9.png" alt="shape">
		</div>
		<div class="cta-thumb-2">
			<img src="${pageContext.request.contextPath}/statices/assets/img/shape/shape-10.png" alt="shape">
		</div>
	</div>
	<!-- cta-area end -->

	<!-- product-area start -->
	<div class="category-product-area pt-120 pb-120">
		<div class="container">
			<div class="row pt-40 justify-content-center">
				<div class="col-xl-8 text-center">
					<div class="section-title-2 mb-70">
						<h3 class="title">Our best selling Global Industrial products</h3>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xl-12">
					<div class="product-tap-wrapper">
						<div class="nav nav-tabs" id="product-tab-nav" role="tablist">
							<a class="nav-item nav-link active" id="product-tab-1" data-toggle="tab" href="#product-tabs-1"
							   role="tab" aria-controls="product-tabs-1" aria-selected="true">
								Warehouse Supplies
							</a>
							<a class="nav-item nav-link" id="product-tab-2" data-toggle="tab" href="#product-tabs-2"
							   role="tab" aria-controls="product-tabs-2" aria-selected="false">
								Bubble & Foam
							</a>
							<a class="nav-item nav-link" id="product-tab-3" data-toggle="tab" href="#product-tabs-3"
							   role="tab" aria-controls="product-tabs-3" aria-selected="false">
								Corrugated Boxes
							</a>
							<a class="nav-item nav-link" id="product-tab-4" data-toggle="tab" href="#product-tabs-4"
							   role="tab" aria-controls="product-tabs-4" aria-selected="false">
								Bubble & Foam
							</a>
							<a class="nav-item nav-link" id="product-tab-5" data-toggle="tab" href="#product-tabs-5"
							   role="tab" aria-controls="product-tabs-5" aria-selected="false">
								Bubble & Foam
							</a>
						</div>
						<div class="tab-content" id="product-tab-content">
							<div class="tab-pane fade show active" id="product-tabs-1" role="tabpanel"
							     aria-labelledby="product-tab-1">
								<div class="product-tab-contents">
									<div class="row">
										<div class="col-xl-3 col-md-6">
											<div class="product-wrap-2 style-2 mb-30">
												<div class="product-thumb">
													<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-24.jpg" alt="product">
													<div class="product-action">
														<a href="#"><i class="far fa-search"></i></a>
														<a href="#"><i class="far fa-shopping-cart"></i></a>
														<a href="#"><i class="far fa-heart"></i></a>
										...
										<div class="col-xl-3 col-md-6">
											<div class="product-wrap-2 style-2 mb-30">
												<div class="product-thumb">
													<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-25.jpg" alt="product">
													<div class="product-action">
														<a href="#"><i class="far fa-search"></i></a>
														<a href="#"><i class="far fa-shopping-cart"></i></a>
														<a href="#"><i class="far fa-heart"></i></a>
										...
										<div class="col-xl-3 col-md-6">
											<div class="product-wrap-2 style-2 mb-30">
												<div class="product-thumb">
													<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-26.jpg" alt="product">
													<div class="product-action">
														<a href="#"><i class="far fa-search"></i></a>
														<a href="#"><i class="far fa-shopping-cart"></i></a>
														<a href="#"><i class="far fa-heart"></i></a>
										...
										<div class="col-xl-3 col-md-6">
											<div class="product-wrap-2 style-2 mb-30">
												<div class="product-thumb">
													<img src="${pageContext.request.contextPath}/statices/assets/img/product/product-27.jpg" alt="product">
													<div class="product-action">
														<a href="#"><i class="far fa-search"></i></a>
														<a href="#"><i class="far fa-shopping-cart"></i></a>
														<a href="#"><i class="far fa-heart"></i></a>
							...
							<div class="tab-pane fade" id="product-tabs-2" role="tabpanel"
							...
							<div class="tab-pane fade" id="product-tabs-3" role="tabpanel"
							...
							<div class="tab-pane fade" id="product-tabs-4" role="tabpanel"
							...
							<div class="tab-pane fade" id="product-tabs-5" role="tabpanel"
		...
		<div class="container">
			...
			<div class="row position-relative mb--170">
				<div class="col-xl-4 col-md-6">
					<div class="blog-wrap-2 mb-30">
						<div class="blog-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/blog/blog-4.jpg" alt="blog">
						</div>
				...
				<div class="col-xl-4 col-md-6">
					<div class="blog-wrap-2 mb-30">
						<div class="blog-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/blog/blog-5.jpg" alt="blog">
						</div>
						<div class="blog-content">
							<div class="blog-meta">
								<span>NEWS</span>
				...
				<div class="col-xl-4 col-md-6">
					<div class="blog-wrap-2 mb-30">
						<div class="blog-thumb">
							<img src="${pageContext.request.contextPath}/statices/assets/img/blog/blog-6.jpg" alt="blog">
						</div>
						<div class="blog-content">
							<div class="blog-meta">
								<span>NEWS</span>

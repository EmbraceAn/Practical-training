		...
		<div class="offset-sidebar">
			<div class="offset-widget offset-logo">
				<a href="index.html"> <img
					src="${pageContext.request.contextPath}/statices/assets/img/logo/logo-3.png"
					alt="logo">
				</a>
			</div>
			...
			<div class="offset-widget">
				<div class="instagram">
					<a href="#"> <img
						src="${pageContext.request.contextPath}/statices/assets/img/category/cat-1.jpg"
						alt="cat">
					</a> <a href="#"> <img
						src="${pageContext.request.contextPath}/statices/assets/img/category/cat-2.jpg"
						alt="cat">
					</a> <a href="#"> <img
						src="${pageContext.request.contextPath}/statices/assets/img/category/cat-3.jpg"
						alt="cat">
					</a> <a href="#"> <img
						src="${pageContext.request.contextPath}/statices/assets/img/category/cat-2.jpg"
						alt="cat">
				...
				<div class="row justify-content-center">
					<div class="col-xl-6 col-lg-8 col-md-8">
						<div class="login-form">
							<form:form action="${pageContext.request.contextPath}/user/user_login" cssClass="form" modelAttribute="user" method="POST">
								<h6><span style="color: red;">${error }</span></h6>
								<div class="row">
									<div class="col-xl-12">
										<div class="input-wrap">
											<form:label path="userPhone">phone*</form:label>
											<form:input path="userPhone" cssClass="validate[required]" />
											<form:errors path="userPhone" cssStyle="color:red;" />
										</div>
									</div>
									<div class="col-xl-12">
										<div class="input-wrap">
											<form:label path="userPsw">Password *</form:label>
									...
									<div class="col-xl-6 col-md-6 col-6">
										<div class="label-text text-right">
											<a href="#">修改密码 /</a> <a href="#">忘记密码</a>
										</div>
									</div>
									<div class="col-xl-12">
										<div class="create-info">
											<span>没有账号？</span>
											<button type="submit" class="create-btn">Create an
												account</button>
										</div>
									</div>
								</div>
